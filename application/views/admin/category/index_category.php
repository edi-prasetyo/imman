        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="category_desc" placeholder="Deskripsi Kategori"></textarea>
                    <?php echo form_error('category_name', '<small class="text-danger">', '</small>'); ?>
                </div>
                    ...
                    <tbody>
                        ...
                        foreach ($category as $category) : ?>
                            <tr>
                                ...
                                <td><img width="10%" src="<?php echo base_url('assets/img/category/' . $category->category_image); ?>"></td>
