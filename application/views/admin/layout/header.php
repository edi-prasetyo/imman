...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/template/web/vendor/fonts/boxicons.css" />
    ...
    <!-- Helpers -->
    <script src="<?php echo base_url() ?>assets/template/web/vendor/js/helpers.js"></script>

    <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
    <!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
    <script src="<?php echo base_url() ?>assets/template/web/js/config.js"></script>
</head>
