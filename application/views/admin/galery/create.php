<div class="col-md-8 mx-auto">
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <label class="col-lg-3 col-form-label">Url <span class="text-success">(Optional)</span>
                </label>
                <div class="col-lg-9">
                    <input type="text" class="form-control" name="galery_url" placeholder="Url" value="<?php echo set_value('galery_url'); ?>">
                </div>
            </div>
