    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                echo form_open('admin/jabatan/update/' . $data->id,   array('class' => 'needs-validation', 'novalidate' => 'novalidate'));

                ?>

                <div class="form-group mb-3">
                    <label>Nama Jabatan</label>
                    <input type="text" class="form-control" name="jabatan_name" value="<?php echo $data->jabatan_name ?>" required>
                    <div class="invalid-feedback">Silahkan masukan nama Jabatan</div>
                </div>
                <div class="form-group mb-3">
                    <label>Nomor Urut</label>
                    <input type="text" class="form-control" name="jabatan_urutan" value="<?php echo $data->jabatan_urutan ?>" required>
