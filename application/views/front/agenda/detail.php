...
<head>
    ...
    <meta property="og:image" content="<?php echo base_url('assets/img/artikel/' . $agenda->agenda_image); ?>" />
    ...
    <div class="breadcrumb">
        <div class="container">
            <ul class="breadcrumb my-3">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url('donasi') ?>"> Agenda</a></li>
    ...
    <div class="container mb-3">
        ...
        <div class="card mb-3">
            <div class="row no-gutters">
                ...
                <div class="col-md-7">
                    <div class="card-body">
                        <h2><?php echo $agenda->agenda_title; ?></h2>
                        <div class="progress" style="height:5px">
                            <div class="progress-bar bg-success" role="progressbar" style="width: 100%" aria-valuenow="" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <div class="my-3">
                            <i class="ti ti-calendar-event"></i> <?php echo  date("j M Y", strtotime($agenda->agenda_date)); ?>
                            <i class="ti ti-clock mr-2 ml-5"></i> <?php echo $agenda->agenda_jam; ?> WIB
                        </div>
                        ...
                        <?php if ($countdown == 0) : ?>
                            <div class="alert alert-primary btn-block mt-2">
                                Sedang Berlangsung
                            </div>

                        <?php elseif ($countdown < 0) : ?>
                            <div class="alert alert-danger btn-block mt-2 disabled">
                                Sudah Berakhir
                            </div>
                        <?php else : ?>
                            <div class="alert alert-success btn-block mt-2">
                                <?php echo "$countdown Hari Lagi"; ?>
                            </div>
                        <?php endif; ?>

                        <?php echo $agenda->agenda_desc; ?>
                    </div>
                </div>
            </div>
        </div>
